...
import "./EcchiGameCurrency.sol";
import "./ERC1155Collectible.sol";
import "@openzeppelin/contracts/token/ERC1155/utils/ERC1155Holder.sol";
import "@openzeppelin/contracts/access/AccessControl.sol";

contract UpgradeNFT is ERC1155Holder, AccessControl {
    ERC1155Collectible public immutable nftContract;
    ...
    constructor(
        ERC1155Collectible _nftContract,
        ...
        setTokenIdsAndProbabilitiesForClass(Class.Game, _gameNFTs, _nftProbabilities);
        setTokenIdsAndProbabilitiesForClass(Class.Silver, _silverNFTs, _nftProbabilities);
        setTokenIdsAndProbabilitiesForClass(Class.Gold, _goldNFTs, _nftProbabilities);
    }
    ...
    function setTokenIdsAndProbabilitiesForClass(
        ...
        require(_tokenIds.length == _probabilities.length, "probabilities not equal to IDs");
    ...
    function forgeGoldNFT() public {
        require(gameCurrency.balanceOf(msg.sender, 2) >= 3, "Not enough common shards");
        require(gameCurrency.balanceOf(msg.sender, 3) >= 1, "Not enough powered shards");
        require(classToTokenIds[2].length == classToProbabilities[2].length, "probabilities do not equal");
    ...
    function forgeSilverNFT() public {
        require(gameCurrency.balanceOf(msg.sender, 3) >= 3, "Not enough common shards");
        require(gameCurrency.balanceOf(msg.sender, 4) >= 1, "Not enough powered shards");
