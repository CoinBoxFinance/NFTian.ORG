...
const Allauthor = () => {
        ...
        <div class="container">
            <div class="section-header justify-content-between">
                <div class="header-title">
                    <span><i class="icofont-light-bulb"></i></span>
                    <h3>All Authors</h3>
                </div>
            ...
            <div class="section-wrapper">
                <div class="explore-wrapper">
                    <div class="row justify-content-center gx-4 gy-3">
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="nft-item style-2">
                                <div class="nft-inner">
                                    <div class="nft-thumb">
                                        <img loading="lazy" src={require('../images/nft-item/style-2/01.jpg').default} alt="" />
                            ...
                            <div class="nft-item style-2">
                                <div class="nft-inner">
                                    ...
                                    <div class="nft-content">
                                        ...
                                        <div class="author-details">
                                            <h5><a href="/author">X31le eko Fernindo</a> </h5>
                                            <p class="nft-price yellow-color">$23,002.98</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="nft-item style-2">
                                <div class="nft-inner">
                                    ...
                                    <div class="nft-content">
                                        <div class="author-thumb">
                                            <a href="/author" class="veryfied">
                                            <img loading="lazy" src={require('../images/seller/03.gif').default} alt="" />
                                                {/* <img loading="lazy"
                                                    src="assets/images/seller/03.png" alt="author-img"> */}
                                             </a>
                                        </div>
                                        <div class="author-details">
                                            <h5><a href="/author">Jhon Doe </a> </h5>
                                            <p class="nft-price yellow-color">$23,002.98</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="nft-item style-2">
                                <div class="nft-inner">
                                    ...
                                    <div class="nft-content">
                                        ...
                                        <div class="author-details">
                                            <h5><a href="/author">Alex joe</a> </h5>
                                            <p class="nft-price yellow-color">$23,002.98</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="nft-item style-2">
                                <div class="nft-inner">
                                    ...
                                    <div class="nft-content">
                                        ...
                                        <div class="author-details">
                                            <h5><a href="/author">Imao XO9 </a> </h5>
                                            <p class="nft-price yellow-color">$23,002.98</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="load-btn mt-5">
                        <a href="all-authors-2.html" class="default-btn move-bottom">
                            <span>Load More</span>
                        </a>
                    </div>
    ...
    <section class="seller-section padding-bottom">
        <div class="container">
                ...
                <div class="header-content d-flex flex-wrap align-items-center">
                    <ul class="seller-filter-btns d-flex flex-wrap mb-0">
                        <li class="seller-filter-btn">
                            <select class="buyer-seller-select">
                        ...
                        <div class="seller-inner">
                            <div class="seller-part">
                                ...
                                <div class="assets-owner">
                                    ...
                                    <div class="owner-content">
                                        <h5><a href="/author">annae de</a> </h5>
                                        <p>$3,002.98</p>
                                    </div>
                                </div>
                            </div>
    ...
    <section class="seller-section padding-bottom">
        <div class="container">
            <div class="section-header">
                <div class="header-title">
                    <span><i class="icofont-badge"></i></span>
                    <h3>Top Authors</h3>
                </div>
                <div class="header-content d-flex flex-wrap align-items-center">
                    <ul class="seller-filter-btns d-flex flex-wrap mb-0">
