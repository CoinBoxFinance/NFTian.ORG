                        ...
                        <div class="item-desc-part">
                            <div class="item-desc-inner">
                                <div class="item-desc-thumb">
                                    <img src={require('../images/nft-item/item-details.gif').default} alt="" />
                                    ...
                                    <div class="tab-content" id="nav-tabContent">
                                        <div class="details-tab tab-pane fade show active" id="nav-details"
                                            ...
                                            <div class="author-profile d-flex flex-wrap align-items-center gap-15">
                                                ...
                                                <div class="author-p-info">
                                                    ...
                                                    <h6><a href="/author">Alex joe</a></h6>
                                                </div>
                                            </div>
                                        ...
                                        <div class="history-tab tab-pane fade" id="nav-history" role="tabpanel"
                                            ...
                                            <ul class="item-histo-list">
                                                <li class="histo-item">
                                                    <p>Created by <a href="/author">@alex joe</a></p>
                                                    <time>2021-08-04 23:05:07</time>
                                                </li>
                                                <li class="histo-item">
                                                    <p>Listed by <a href="/author">@alex joe</a></p>
                                                    <time>2021-08-04 20:05:07</time>
                                                </li>
                                                <li class="histo-item">
                                                    <p>Owned by <a href="/author">@alex joe</a></p>
                    ...
                    <div class="col-lg-6">
                        <div class="item-buy-part">
                            ...
                            <div class="buying-btns d-flex flex-wrap">
                                <a href="/wallet" class="default-btn move-right"><span>Buy Now</span> </a>
                                <a href="/wallet" class="default-btn move-right"><span>Place a Bid</span> </a>
                            </div>
                        </div>
                    </div>
                </div>
